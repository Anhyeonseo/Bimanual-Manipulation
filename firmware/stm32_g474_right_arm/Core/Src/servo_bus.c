...
const ServoJointConfig servo_joints[SINGLE_ARM_JOINT_COUNT] = {
    /* Provisional upstream envelopes remain useful to simulation and review,
     * but every local ASCII jog is disabled until right-arm calibration. */
    {1U, "BASE",        0U, 2048U, 2048U, 2610U, 16U,  1, 34U, 600U, 400U},
    {2U, "SHOULDER",    0U, 2048U, 1988U, 3766U, 32U,  1, 34U, 1200U,
        SERVO_SHOULDER_TORQUE_LIMIT_RAW},
    {3U, "ELBOW",       0U, 2048U, 627U, 2258U, 28U, -1, 34U, 1000U,
        SERVO_ELBOW_TORQUE_LIMIT_RAW},
    {4U, "WRIST_FLEX",  0U, 2048U, 1194U, 2048U, 16U, -1, 34U, 800U, 400U},
    {5U, "WRIST_ROLL",  0U, 2048U, 1874U, 2219U, 16U,  1, 34U, 500U, 250U},
    {6U, "GRIPPER",     0U, 2048U, 1866U, 2048U, 16U, -1, 34U, 800U, 150U}
};
